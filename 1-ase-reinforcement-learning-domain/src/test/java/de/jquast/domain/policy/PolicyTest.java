...
public class PolicyTest {
    ...
    @Test
    public void selectBestActionShouldReturnMaximizedAction() {
    ...
    @Test
    public void detailedConstructorShouldInitStoreCorrectly() {
    ...
    @Test
    public void allGetterShouldReturnIdentity() {
