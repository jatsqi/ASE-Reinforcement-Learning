...
public enum DefaultConfigItem {
    ...
    ALGORITHM_EXPLORATION_RATE("DEFAULT_ALGORITHM_EXPLORATION_RATE", null, "0.3"),
    ...
    MESSAGE_TRAINING_AVERAGE_REWARD_MS("DEFAULT_MESSAGE_TRAINING_AVERAGE_REWARD_MS", null, "300");
